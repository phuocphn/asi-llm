...
from generate_scripts.grok_small_56.cm import extract_current_mirrors
from generate_scripts.grok_small_56.dp import find_differential_pairs
from generate_scripts.grok_small_56.inv import extract_inverters
import glob
import json
...
def test_single_example():
    ...
    # print(dp)
    invs = extract_inverters(data.netlist)
    # print(invs)

...
from generate_scripts.deepseek_medium_56.cm import identify_current_mirrors
from generate_scripts.deepseek_medium_56.dp import find_differential_pairs
from generate_scripts.deepseek_medium_56.inv import find_inverters
import glob
import json
...
def test_single_example():
    ...
    cm = identify_current_mirrors(data.netlist)
    # print(cm)
    dp = find_differential_pairs(data.netlist)
    # print(dp)
    invs = find_inverters(data.netlist)
    # print(invs)
